...
abstract class AuthDataSource {
  ...
  Future<MyResult<GenericResponseModel>> getCountries();

  Future<MyResult<GenericResponseModel>> getStates(StatesParams params);

  Future<MyResult<GenericResponseModel>> getCities(CityParams params);
  ...
  Future<MyResult<GenericResponseModel>> getSocial();
