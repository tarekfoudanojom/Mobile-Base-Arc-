...
class _$VerifyCodeModelImpl extends _VerifyCodeModel {
  ...
  @override
  String toString() {
    return 'VerifyCodeModel(status: $status, message: $message, token: $token)';
  }
...
abstract class _VerifyCodeModel extends VerifyCodeModel {
  factory _VerifyCodeModel(
          {@JsonKey(name: "status") required final bool status,
          @JsonKey(name: "message") required final String message,
          @JsonKey(name: "token") required final String token}) =
      _$VerifyCodeModelImpl;
  _VerifyCodeModel._() : super._();
