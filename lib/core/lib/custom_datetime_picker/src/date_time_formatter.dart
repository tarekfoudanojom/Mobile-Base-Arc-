...
class DateTimeFormatter {
  ...
  static List<String> splitDateFormat(String? dateFormat,
    ...
    if (mode == DateTimePickerMode.datetime) {
      ...
      if (dayFormat.length > 0) {
        ...
        temp.insert(0, datePickerFormat);
      }
      result = temp;
    }
    return result;
  ...
  /// Method that get the DateTime object for this date format DD/MM/YYYY
  static DateTime? getDateTimeFromText(String text) {
    try {
      final date = text.split('/');
