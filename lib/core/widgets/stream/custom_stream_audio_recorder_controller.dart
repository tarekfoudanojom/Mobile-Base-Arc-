...
/// accordingly.
/// {@endtemplate}
class CustomStreamAudioRecorderController extends ValueNotifier<AudioRecorderState> {
  /// {@macro streamAudioRecorderController}
  factory CustomStreamAudioRecorderController({
    RecordConfig? config,
    Duration amplitudeInterval = const Duration(milliseconds: 100),
  }) {
    return CustomStreamAudioRecorderController.raw(
  ...
  /// {@macro streamAudioRecorderController}
  @visibleForTesting
  CustomStreamAudioRecorderController.raw({
